...
void Graph::InsertEdge(const int& vertex1, const int& vertex2, int choice, int weight)//добавление нового ребра
{
	if (weight < 1)
	{
...
int Graph::GetAmountEdges(int choice) //получение количества ребер в графе
{
	int numb = 0;
	if (!IsEmpty())
	{
